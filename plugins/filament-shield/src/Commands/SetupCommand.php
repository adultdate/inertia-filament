    ...
    public function handle(): int
    {
        ...
        if (! $this->option('starred') && confirm('Would you like to show some love by starring the repo?', true)) {
            if (PHP_OS_FAMILY === 'Darwin') {
                exec('open https://github.com/adultdate/filament-shield');
            }

            if (PHP_OS_FAMILY === 'Linux') {
                exec('xdg-open https://github.com/adultdate/filament-shield');
            }

            if (PHP_OS_FAMILY === 'Windows') {
                exec('start https://github.com/adultdate/filament-shield');
            }
