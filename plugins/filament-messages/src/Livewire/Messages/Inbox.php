...
use Adultdate\FilamentMessages\Filament\Pages\Messages as MessagesPage;
...
final class Inbox extends Component implements HasActions, HasForms
{
    ...
    {
        $this->conversations = InboxModel::whereJsonContains('user_ids', Auth::id())->get();
        $this->markAsRead();
    }
    ...
    public function createConversation(): Action
    {
        return Action::make('createConversation')
            ...
            ->action(function (array $data) {
                ...
                redirect(MessagesPage::getUrl(['id' => $inboxId]));
            })->extraAttributes([
                'class' => 'w-full',
            ]);
    }
